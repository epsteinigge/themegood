  ...
  host.innerHTML = variants.map((variant) => `
    <div class="bundle-extra-row" data-size-key="${escapeAttr(variant.key)}">
      <div>
        ...
        <p class="helper" style="margin:8px 0 0;">Used only for legacy/custom bundle pricing. Business-rule 800g bundles calculate automatically.</p>
      </div>
      <div class="field">
        <label>Bundle Extra Price (RM)</label>
    ...
    <div class="variant-row" data-variant-id="${Number(variant.id)}" data-product-id="${Number(productId)}">
      <div class="variant-grid">
        ...
        <div class="field">
          ...
          <div class="helper">Optional legacy/custom bundle override. Leave 0 for automatic business-rule bundles.</div>
        </div>
